...
const mobileDashboardSource = await readFile(new URL('../pages/user_dashboard.jsx', import.meta.url), 'utf8');

const managerDashboardSource = await readFile(new URL('../pages/manager_dashboard.jsx', import.meta.url), 'utf8');
