...
assert.deepEqual(empty.dnaMutationTotals, { stateMutation: 0, contextMaskMutation: 0, profileMutation: 0, copyNumberMutation: 0, weightNudge: 0, vepFiltered: 0 });
...
const populated = normalizeAisTrainingStats({
  ...
  dnaMutationTotals: { stateMutation: 5, contextMaskMutation: 6, profileMutation: 7, copyNumberMutation: 8, weightNudge: 9, vepFiltered: 10 },
...
assert.deepEqual(populated.dnaMutationTotals, { stateMutation: 5, contextMaskMutation: 6, profileMutation: 7, copyNumberMutation: 8, weightNudge: 9, vepFiltered: 10 });
