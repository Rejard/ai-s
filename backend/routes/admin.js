...
async function performSystemDiagnostics() {
  ...
  const details = {
    ...
    councilPhenotypeShapeCheck: { status: "OK", message: "진단 대기" },
    factionClassificationIntegrityCheck: { status: "OK", message: "진단 대기" },
    evolutionTimestampConsistencyCheck: { status: "OK", message: "진단 대기" },
    briefingFreshnessCheck: { status: "OK", message: "진단 대기" },
  ...
  const diagnostics = [
    ...
    { name: "의회 분파 편중도 (HHI)", status: hhiStatus, percentage: hhiStatus === "OK" ? 100 : (hhiStatus === "WARNING" ? 50 : 0), details: hhiMsg },
    ...
    { name: "분파 미할당(NULL) 데이터 오염", status: nullFactionStatus, percentage: nullFactionStatus === "OK" ? 100 : 0, details: nullFactionMsg },
    ...
    { name: "AI 발현 가중치 구조 정합성", status: phenotypeShapeStatus, percentage: phenotypeShapeStatus === "OK" ? 100 : (phenotypeShapeStatus === "WARNING" ? 50 : 0), details: phenotypeShapeMsg },
    { name: "분파 분류 체계 무결성", status: factionIntegrityStatus, percentage: factionIntegrityStatus === "OK" ? 100 : (factionIntegrityStatus === "WARNING" ? 50 : 0), details: factionIntegrityMsg },
    { name: "진화 타임스탬프 일관성", status: timestampConsistencyStatus, percentage: timestampConsistencyStatus === "OK" ? 100 : (timestampConsistencyStatus === "WARNING" ? 50 : 0), details: timestampConsistencyMsg },
    { name: "의회 브리핑 보고서 최신성", status: briefingFreshnessStatus, percentage: briefingFreshnessStatus === "OK" ? 100 : (briefingFreshnessStatus === "WARNING" ? 50 : 0), details: briefingFreshnessMsg },
    { name: "강제 진화 실행 경로 검증", status: forceEvolutionExecutionStatus, percentage: forceEvolutionExecutionStatus === "OK" ? 100 : (forceEvolutionExecutionStatus === "WARNING" ? 50 : 0), details: forceEvolutionExecutionMsg },
    { name: "실시간 DNA 복구 텔레메트리", status: runtimeRepairTelemetryStatus, percentage: runtimeRepairTelemetryStatus === "OK" ? 100 : (runtimeRepairTelemetryStatus === "WARNING" ? 50 : 0), details: runtimeRepairTelemetryMsg },
    { name: "후보군-의회 간 성향 괴리도", status: narrativeDivergenceStatus, percentage: narrativeDivergenceStatus === "OK" ? 100 : (narrativeDivergenceStatus === "WARNING" ? 50 : 0), details: narrativeDivergenceMsg },
    { name: "AI 출신 배경 다양성 (Origin)", status: originDiversityStatus, percentage: originDiversityStatus === "OK" ? 100 : (originDiversityStatus === "WARNING" ? 50 : 0), details: originDiversityMsg },
